...
return "📭│المهندسنا الان ارسل التوجيه للاذاعه \n🔛" 
end
...
return "📭│المهندسنا الان ارسل الكليشه للاذاعه عام \n🔛" 
end
...
return "📭│المهندسنا الان ارسل الكليشه للاذاعه خاص \n🔛"
end
...
return "📭│المهندسنا الان ارسل الكليشه للاذاعه للمجموعات \n🔛" 
end
...
return '👨🏾‍🔧│ اصدار سورس𝑆𝑃𝑂𝑁𝐺𝐸𝐵𝑂𝐵: *v'..version..'* \n📡'
end
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس 𝑆𝑃𝑂𝑁𝐺𝐸𝐵𝑂𝐵 يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/yy8gf"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : مـاكـس](t.me/yy8gf)',nil,inline,msg.id_)
return false
end
...
return "📭│المهندسنا الان ارسل كلمة الرد العام 🍃\n"
end
...
return "📭│المهندسنا , الان ارسل كلمه الرد \n-"
end
...
elseif Text== "المهندس" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/n3n3nh")
elseif Text== "المهندس" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس 𝑆𝑃𝑂𝑁𝐺𝐸𝐵𝑂𝐵 😍](t.me/n3n3nh")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/yy8gf)
]] )
--=====================================
